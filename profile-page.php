...
<main class="account__page common-page">
	<section class="section-rule">
		<article class="profile card">
			<div class="card__img">
				<img src="./gallery/pp1.jpg" alt="">
			</div>
			<div class="card__body">
				<h2 class="card__title">Laxman Adhakari</h2>
				<h2 class="small__title">9825131071</h2>
				<h2 class="small__title">New Road, 111 XXXXXXX</h2>
			</div>
		</article>
	</section>
	<section class="tabs">
				...
				<article class="col-6">
					<a class="card bg card__margin" href="#">
						...
						<div class="card__body">
							...
							<h2 class="small__title">Saved: 1,000</h2>
...
<div class="modal fade login-form" id="addr" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
			...
			<div class="modal-body">
				<form action="" class="form">
					<div class="form-group">
						<label for="Address">New Full Address</label>
						<input type="text" placeholder="Address" class="form-control" id="Address">
					</div>
					<div class="form-group">
						<label for="numb">New Phone Number</label>

						<input type="tel" placeholder="Number" class="form-control" id="numb">
					</div>
